...
| Font                  | Slim                                                                                     | Standard                                                                                     |
|-----------------------|------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------|
| NotoSans-unhinted     | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSans-unhinted-slim.zip)     | -                                                                                            |
| NotoSansCJKsc-hinted  | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSansCJKsc-hinted-slim.zip)  | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSansCJKsc-hinted-standard.zip)  |
| NotoSansCJKtc-hinted  | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSansCJKtc-hinted-slim.zip)  | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSansCJKtc-hinted-standard.zip)  |
| NotoSansCJKjp-hinted  | -                                                                                        | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSansCJKjp-hinted-standard.zip)  |
| NotoSansCJKkr-hinted  | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSansCJKkr-hinted-slim.zip)  | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSansCJKkr-hinted-standard.zip)  |
| NotoSerif-unhinted    | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSerif-unhinted-slim.zip)    | -                                                                                            |
| NotoSerifCJKsc-hinted | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSerifCJKsc-hinted-slim.zip) | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSerifCJKsc-hinted-standard.zip) |
| NotoSerifCJKtc-hinted | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSerifCJKtc-hinted-slim.zip) | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSerifCJKtc-hinted-standard.zip) |
| NotoSerifCJKjp-hinted | -                                                                                        | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSerifCJKjp-hinted-standard.zip) |
| NotoSerifCJKkr-hinted | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSerifCJKkr-hinted-slim.zip) | [Download](https://github.com/krescentmoon/webfont-noto/blob/master/release/NotoSerifCJKkr-hinted-standard.zip) |
